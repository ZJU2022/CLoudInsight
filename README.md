...
# 文件夹说明
- demo 文件夹包含基于 Go 语言及相关框架的 Web 开发示例，包括接口设计和插件使用，以及最佳实践项目
- cloud 文件夹包含云计算基础知识讲解，主机，网络，容器，存储，运维等，理解云计算业务形态
- cloud-products-testing：该文件夹介绍公有云业务线各个云产品如何进行测试，如云监控，云主机，Kubernetes，云数据库等，包括业务测试，自动化设计，性能测试等，团队成员可以了解如何高效地进行云产品的测试，确保产品质量和稳定性。
